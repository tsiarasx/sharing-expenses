          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <section className="bg-[#EAEFF5] px-7 py-8 sm:px-10 sm:py-12 lg:min-h-[640px] lg:rounded-r-[44px]">
              ...
              <p className="mt-3 max-w-sm text-sm font-medium text-slate-500">
                Keep shared expenses organized with the same clean dashboard experience.
              </p>

              <div className="mt-8 space-y-4">
                <div className="rounded-2xl border border-[#d6e0ec] bg-white px-4 py-3 text-sm font-semibold text-slate-600 shadow-sm">
                  Track balances across all your groups in one place.
                </div>
                <div className="rounded-2xl border border-[#d6e0ec] bg-white px-4 py-3 text-sm font-semibold text-slate-600 shadow-sm">
                  Settle up faster with clear debt summaries.
                </div>
                <div className="rounded-2xl border border-[#d6e0ec] bg-white px-4 py-3 text-sm font-semibold text-slate-600 shadow-sm">
                  Stay up to date with real-time activity and notifications.
                </div>
              </div>
            </section>
            ...
            <section className="px-7 py-8 sm:px-10 sm:py-12">
              <div className="mx-auto w-full max-w-md">
                ...
                <div className="mb-6">
                  <h3 className="text-2xl font-bold tracking-tight text-slate-700">Sign in</h3>
